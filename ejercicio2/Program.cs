...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        Empleado empleado1 = new Empleado("Juan","Perez",new DateTime(1993,01,17),'s','M',new DateTime(2005,01,01),150000,cargos.Ingeniero);
        Empleado empleado2 = new Empleado("Franco","Diaz",new DateTime(1991,12,03),'c','M',new DateTime(2000,08,21),100000,cargos.Aministrativo);
        Empleado empleado3 = new Empleado("Melina","Heredia",new DateTime(2002,06,17),'s','F',new DateTime(2021,01,01),120000,cargos.Investigador);
        Empleado empleado4 = new Empleado("Rafael","Lopez",new DateTime(1990,05,01),'c','M',new DateTime(2008,01,01),65000,cargos.Especialista);
        
        salario1=empleado1.calculaSalario();
        Console.WriteLine("Concepto: Salario1 || Monto:"+salario1);
        salario2=empleado2.calculaSalario();
        Console.WriteLine("Concepto: Salario2 || Monto:"+salario2);
        salario3=empleado3.calculaSalario();
        Console.WriteLine("Concepto: Salario3 || Monto:"+salario3);
        salario4 = empleado4.calculaSalario();
